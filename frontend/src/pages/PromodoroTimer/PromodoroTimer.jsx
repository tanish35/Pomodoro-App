...
const Pomodoro = () => {
  ...
  const [playListLink, setPlayListLink] = useState("https://open.spotify.com/playlist/37i9dQZF1DZ06evNZVVBPG?si=8bc8cebd99fb492f");
  ...
  <div className="rounded-lg pr-5">
    <div className="flex">
      ...
      <input type="text" value={inputLink} onChange={(e) => setInputLink(e.target.value)} className="w-full max-w-[160px] bg-white pl-2 text-base text-black font-semibold outline-0" placeholder="" id="" />
      <input type="button" value="Search" className="bg-blue-500 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold hover:bg-blue-800 transition-colors" onClick={(e) => setPlayListLink(inputLink)} />
    </div>
  </div>
</div>
